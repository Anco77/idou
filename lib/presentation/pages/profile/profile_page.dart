...
class ProfilePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    for (final item in items) {
      seriesMap.update(item.series, (v) => v + item.currentQty,
          ifAbsent: () => item.currentQty);
    }
    final maxSeriesQty = seriesMap.values.isEmpty
        ? 1
        : seriesMap.values.reduce((a, b) => a > b ? a : b);
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Container(
                                    ...
                                    child: FractionallySizedBox(
                                      widthFactor: (e.value / maxSeriesQty)
                                          .clamp(0.0, 1.0),
                                      child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _SettingsTile(
                  ...
                  title: '低量预警阈值',
                  subtitle: (ref) =>
                      '当前 ${ref.watch(userSettingsProvider).lowStockThreshold} 颗',
                ...
                _SettingsTile(
                  ...
                  title: '默认补货数量',
                  subtitle: (ref) =>
                      '当前 ${ref.watch(userSettingsProvider).defaultRestockQty} 颗',
                ...
                ListTile(
                  leading:
                      const Icon(Icons.restart_alt, color: AppColors.primary),
  ...
  Future<void> _exportData(BuildContext context, WidgetRef ref) async {
    try {
      ...
      final file = File(
          '${dir.path}/idou_export_${DateTime.now().millisecondsSinceEpoch}.json');
          ...
          FilledButton(
            onPressed: () {
              ...
              ref
                  ...
                  .initializeInventory(defaultQty: qty);
            },
